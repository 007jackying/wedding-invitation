...
export const translations: Record<"en" | "cn", TranslationSchema> = {
  en: {
    hero: {
      ...
      names: "Eva & Vincent",
      datePlace: "September 12, 2026 • Florence, Italy",
      scrollText: "Scroll",
      countdownDays: "Days",
    ...
    details: {
      ...
      byDate: "Kindly respond by August 1, 2026",
      ...
      cards: {
        when: {
          title: "When",
          dateLabel: "Date",
          dateVal: "Saturday, September 12, 2026",
          timelineLabel: "Timeline",
          item1: "04:00 PM — Welcoming & Drinks",
          item2: "04:30 PM — Marriage Ceremony",
          item3: "06:00 PM — Banquet Dinner",
          item4: "09:00 PM — Dancing & Celebration",
        },
        where: {
          title: "Where",
          venueLabel: "Venue",
          venueVal: "Villa di Maiano",
          addressLabel: "Address",
          addressVal: "Via del Salviatino, 1, 50137 Fiesole, Florence, Tuscany, Italy",
    ...
    footer: {
      copyright: "Eva & Vincent • September 12, 2026",
  ...
  cn: {
    ...
    details: {
      ...
      cards: {
        when: {
          title: "时间安排",
          dateLabel: "日期",
          dateVal: "2026年9月12日 星期六",
          timelineLabel: "流程安排",
          item1: "下午 04:00 — 宾客入场与迎宾饮品",
          item2: "下午 04:30 — 婚礼仪式",
          item3: "晚上 06:00 — 婚宴晚宴",
          item4: "晚上 09:00 — 派对与狂欢",
        },
        where: {
          title: "婚礼场地",
          venueLabel: "场地",
          venueVal: "迈亚诺别墅 (Villa di Maiano)",
          addressLabel: "地址",
          addressVal: "Via del Salviatino, 1, 50137 Fiesole, Florence, Tuscany, Italy",
          mapLink: "在谷歌地图中查看 →",
          wazeLink: "在 Waze 中查看 →",
    ...
    footer: {
      copyright: "Eva & Vincent • 2026年9月12日",
